...
<body class="bg-slate-100 font-sans antialiased min-h-screen flex items-center justify-center p-4 md:p-8">
    ...
    <div class="max-w-2xl w-full bg-white rounded-2xl border border-slate-200 shadow-xl p-6 md:p-8">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-slate-800">School Edit</h1>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <!-- Father's Name -->
            <div>
                <label for="father_name" class="block text-sm font-medium text-slate-700 mb-1.5">Phone</label>
                <input
                    type="text"
                    id="phone"
                    name="phone"
            ...
            <!-- Mother's Name -->
            <div>
                <label for="mother_name" class="block text-sm font-medium text-slate-700 mb-1.5">Address</label>
                <input
                    type="text"
                    id="address"
                    name="address"
